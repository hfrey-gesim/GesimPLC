...
<Root>
  <Header Id="c9a5efa5-f9b5-445c-b8ef-70985bdbc6dc" ObjType="MZHead" ObjName="Head" Version="V2.0.17"></Header>
  ...
  <Slots>
    ...
    <Item Nr="1" Name="Axis 1" RelPos.X="-44500" RelPos.Y="0" RelPos.Z="108000" Diameter="18000" Disabled="FALSE">
      <ChildLimit>
        ...
        <Item ObjType="TriplePip"></Item>
        <Item ObjType="TitrationTool"></Item>
