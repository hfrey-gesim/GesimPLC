...
<Root>
  <Header Id="fa4d961d-b8ef-4dff-9988-c7c6dcb4763e" ObjType="SubstHolder" ObjName="SingleSubstrateHeater (Internal)" Version="V2.0.17"></Header>
  <Picture File="single_substrate_holder_heater_external_vertical_bottom.png">
    <Dimension X="86000" Y="143800" />
    <Offset X="0" Y="-15800" />
  </Picture>
  ...
  <Categories>
    <Item>single+add+internal+vertical+bottom</Item>
  </Categories>
</Root>