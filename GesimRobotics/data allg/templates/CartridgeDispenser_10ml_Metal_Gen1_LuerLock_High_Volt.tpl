...
<Root>
  <Header Id="622fa026-1625-4f8a-b52e-88a5d8d2e959" ObjType="CartridgeDisp" ObjName="Cartridge Dispenser (10ml/High Voltage)" Version="V2.0.17" />
  <Picture File="cartridge_dispenser_10ml_metal_gen1_luerlock_high_volt.png" InFrontOfPieces="TRUE">
    <Dimension X="34000" Y="114200" />
    <Offset X="-17000" Y="2000" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-92600" Max="-92600" Default="-92600" Step="500" />
  ...
  <Slots>
    <Item Nr="1" Name="Nozzle Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="5300" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Nozzle">
          <Categories>
            <Item>luerlock</Item>
