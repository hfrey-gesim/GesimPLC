...
<Root>
  <Header Id="d50be9b3-cc6e-4ecb-8331-ef2353b35706" ObjType="TwinExtruder" ObjName="Twin PureDyne-Extruder" Version="V2.0.17" />
  <Picture File="twin_puredyne_extruder_sn2477.png">
    <Dimension X="54000" Y="50000" />
    <Offset X="-27000" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.X Min="-52500" Max="-52500" Default="-52500" Step="500" />
    <RelPos.Y Min="-17500" Max="-17500" Default="-17500" Step="500" />
    <RelPos.Z Min="-147891" Max="-147891" Default="-147891" Step="500" />
    <HeaterExist Default="FALSE" />
  </DefaultProperties>
  <Slots>
    <Item Nr="1" Name="Right Extruder" RelPos.X="0" RelPos.Y="-18000" RelPos.Z="50000" Disabled="FALSE">
      <ChildLimit>
    ...
    <Item Nr="2" Name="Left Extruder" RelPos.X="0" RelPos.Y="18000" RelPos.Z="50000" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Extruder">
          <Categories>
            <Item>puredyne_2_mixer</Item>
          </Categories>
        </Item>
      </ChildLimit>
    </Item>
    <Item Nr="3" Name="Nozzle Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="5200" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Nozzle">
          <Categories>
            <Item>luerlock</Item>
