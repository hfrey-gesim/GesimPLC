...
<Root>
  <Header Id="603738db-4239-49b5-a4a4-a8da1798380e" ObjType="TwinExtruder" ObjName="Twin Syringe-Extruder" Version="V2.0.17" />
  <Picture File="twin_syringe_extruder_luerlock.png">
    <Dimension X="71000" Y="140000" />
    <Offset X="-35500" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    <!--RelPosY von Achse 1 (wenn z.B. Achse5 = aktiv) zu NozzleSlot = 17500-->
    <!--RelPosY von Achse 2 (wenn z.B. Achse7 = aktiv) zu NozzleSlot = -18500-->
    <RelPos.X Min="-45500" Max="-45500" Default="-45500" Step="500" />
    <RelPos.Y Min="-18500" Max="-18500" Default="-18500" Step="500" />
    <RelPos.Z Min="-103500" Max="-103500" Default="-103500" Step="500">
      <!--original nach CAD -104500, aber Erfahrung hat diese Differnz gezeigt-->
    </RelPos.Z>
    <HeaterExist Default="FALSE" />
  </DefaultProperties>
  <Slots>
    <Item Nr="1" Name="Right Extruder" RelPos.X="0" RelPos.Y="-18000" RelPos.Z="42500" Disabled="FALSE">
      <ChildLimit>
    ...
    <Item Nr="2" Name="Left Extruder" RelPos.X="0" RelPos.Y="18000" RelPos.Z="42500" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Extruder">
          <Categories>
    ...
    <Item Nr="3" Name="Nozzle Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="5500" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Nozzle">
          <Categories>
            <Item>luerlock</Item>
  ...
  <ActionLimits>
    ...
    <MoveZ SequenceUsage="TRUE" HiddenInManu="TRUE" ActionText="Move Z">
      ...
      <SpeedZ Min="10" Max="50000" Default="10000" Step="100" />
    </MoveZ>
