...
<Root>
  <Header Id="dfa8f5d5-dc3f-4e95-b733-5da3ddb42919" ObjType="Camera" ObjName="Camera" Version="V2.0.17" />
  <PossibleParentTypes OnlySlots="TRUE">
    <Item>StampSupport</Item>
  </PossibleParentTypes>
  <DefaultProperties>
    <RelPos.X Min="0" Max="0" Default="0" Step="100">
      <!--reiner CAD-Wert - -> Kamera unbedingt einteachen-->
    </RelPos.X>
    <RelPos.Y Min="0" Max="0" Default="0" Step="100">
      <!--reiner CAD-Wert - -> Kamera unbedingt einteachen-->
    </RelPos.Y>
    <RelPos.Z Min="-206350" Max="-206350" Default="-206350" Step="100" />
    <WorkingDistance Min="10000" Max="150000" Default="20000" Step="100" />
  </DefaultProperties>
  <ActionLimits>
    <Jog ActionText="Jog">
