...
<Root>
  <Header Id="3990dd81-e3e6-4e35-993e-0d5588ffef80" ObjType="Workplate" ObjName="Workplate" Version="V2.0.17" />
  ...
  <Slots>
    <Item Nr="1" Name="Stroboscope Slot" RelPos.X="160500" RelPos.Y="19500" RelPos.Z="0" Depth="0" Diameter="0" Disabled="TRUE">
      <ChildLimit>
    ...
    <Item Nr="2" Name="MtpHolder Slot Left" RelPos.X="25000" RelPos.Y="2000" RelPos.Z="0" Depth="0" Diameter="0" Disabled="TRUE">
      <ChildLimit>
    ...
    <Item Nr="3" Name="MtpHolder Slot Right" RelPos.X="267000" RelPos.Y="8000" RelPos.Z="0" Depth="0" Diameter="0" Disabled="TRUE">
      <ChildLimit>
        <Item ObjType="MtpHolder">
          <Categories>
    ...
    <Item Nr="4" Name="DryPad Slot" RelPos.X="253750" RelPos.Y="99000" RelPos.Z="0" Depth="0" Diameter="0" Disabled="TRUE">
      <ChildLimit>
        <Item ObjType="DryPad">
          <Categories>
    ...
    <Item Nr="5" Name="WashStation Slot" RelPos.X="361500" RelPos.Y="112000" RelPos.Z="0" Depth="0" Diameter="0" Disabled="TRUE">
      <ChildLimit>
