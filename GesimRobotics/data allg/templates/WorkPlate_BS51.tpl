...
<Root>
  <Header Id="a291304d-4147-41da-af9f-c34fdeb3275a" ObjType="Workplate" ObjName="Workplate" Version="V2.0.17" />
  ...
  <Slots>
    <Item Nr="1" Name="Targettray Slot" RelPos.X="55000" RelPos.Y="43000" RelPos.Z="-3000" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
    ...
    <Item Nr="2" Name="Servicetray Slot" RelPos.X="315000" RelPos.Y="43000" RelPos.Z="-3000" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="TargetTray">
          <Categories>
