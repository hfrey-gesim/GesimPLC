...
<Root>
  <Header Id="dd1cc098-e1f5-4449-a24b-940492a289a4" ObjType="CartridgeDisp" ObjName="Syringe Dispenser (1ml)" Version="V2.0.17" />
  <Picture File="syringe_dispenser_1ml_plastic.png" InFrontOfPieces="TRUE">
    <Dimension X="34000" Y="183100" />
    <Offset X="-17000" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-91000" Max="-70000" Default="-83000" Step="500" />
  ...
  <Slots>
    <Item Nr="1" Name="Nozzle Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="3180" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Nozzle">
          <Categories>
            <Item>luerlock</Item>
