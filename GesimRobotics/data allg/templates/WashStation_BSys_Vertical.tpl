...
<Root>
  <Header Id="53860271-30eb-49d3-a0df-a263b5fef052" ObjType="WashStation" ObjName="WashStation" Version="V2.0.17" />
  <Picture File="washstation_bsys_vertical.png">
  ...
  <DefaultProperties>
    ...
    <Height Min="44000" Max="44000" Default="44000" Step="100" />
    <PumpNrWaste Min="1" Max="9" Default="5" Step="1" />
    <ValveNrAirShower Min="0" Max="5" Default="0" Step="1" />
  ...
  <SpecPoints>
    ...
    <Item Nr="2" Name="WashPoint2" Visible="TRUE" RinseChannel="1">
      <RelPos.X Min="18000" Max="22000" Default="20000" />
