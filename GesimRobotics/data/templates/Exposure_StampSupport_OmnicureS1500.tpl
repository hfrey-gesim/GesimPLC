...
<Root>
  <Header Id="b4d4235e-69d5-4ef3-ba8f-f35813577fed" ObjType="Exposure" ObjName="Omnicure S1500" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-64400" Max="-64400" Default="-64400" Step="100" />
    <TriggerBehavior Min="0" Max="1" Default="1" Step="1" />
    <TriggerChannel Min="1" Max="3" Default="1" Step="1" />
    <WorkingDistance Min="20000" Max="50000" Default="20000" Step="100" />
  </DefaultProperties>
  <ActionLimits>
    <Jog ActionText="Jog">
