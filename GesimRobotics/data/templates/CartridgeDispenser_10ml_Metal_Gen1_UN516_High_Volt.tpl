...
<Root>
  <Header Id="22094cc2-cfee-450b-a504-e15ddaed32aa" ObjType="CartridgeDisp" ObjName="Cartridge Dispenser (10ml/High Voltage)" Version="V2.0.17" />
  <Picture File="cartridge_dispenser_10ml_metal_gen1_screw_high_volt.png" InFrontOfPieces="TRUE">
    <Dimension X="34000" Y="101100" />
    <Offset X="-17000" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-77000" Max="-77000" Default="-77000" Step="500" />
    <ItvChanPress Min="1" Max="3" Default="1" Step="1" />
    <ItvChanVac Min="1" Max="3" Default="3" Step="1" />
    <DigiOutMzValvePress Min="5" Max="7" Default="7" Step="1" />
    <ShowVac Default="FALSE" />
    <IsMES Default="TRUE" />
  </DefaultProperties>
  <Slots>
    <Item Nr="1" Name="Nozzle Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="7000" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Nozzle">
          <Categories>
            <Item>5_16</Item>
