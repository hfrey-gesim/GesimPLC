...
<Root>
  <Header Id="918b10d1-d942-4800-bc18-4608f9b92322" ObjType="CartridgeHolder" ObjName="CartridgeHolder (HV/Internal Heater)" Version="V2.0.17" />
  <Picture File="cartridge_holder_with_heater_gap_gen1_high_volt.png" InFrontOfPieces="TRUE">
    <Dimension X="49000" Y="155800" />
    <Offset X="-32000" Y="0" />
  </Picture>
  ...
  <SeqProcVariables>
    <Item VariableType="Temp1" Name="Temp Core" Min="200" Max="1000" Default="200" />
  </SeqProcVariables>
  <ActionLimits>
    <Jog ActionText="Jog">
