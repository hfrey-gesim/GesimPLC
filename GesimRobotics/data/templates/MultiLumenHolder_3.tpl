...
<Root>
  <Header Id="5a727db6-6e39-4f02-87b4-5e10b295f176" ObjType="TitrationTool" ObjName="3-Lumen-Pipette" Version="V2.0.17" />
  <Picture File="multi_lumen_holder_3.png">
  ...
  <Slots>
    <Item Nr="1" Name="Lumen 1" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Disabled="FALSE">
      <!--eig. RelPosX/Y/Z = 425/736/0 -> wurde geändert WashPoint zentral angefahren wird-->
      <ChildLimit>
    ...
    <Item Nr="2" Name="Lumen 2" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Disabled="FALSE">
      <!--eig. RelPosX/Y/Z = 425/-736/0 -> wurde geändert WashPoint zentral angefahren wird-->
      <ChildLimit>
        <Item ObjType="PassivePip">
          <Categories>
    ...
    <Item Nr="3" Name="Lumen 3" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="PassivePip">
          <Categories>
            <Item>dispense+multilumen</Item>
      ...
      <!--eig. RelPosX/Y/Z = -850/0/0 -> wurde geändert WashPoint zentral angefahren wird-->
    </Item>
  </Slots>
  <ActionLimits>
    <Jog ActionText="Jog">
