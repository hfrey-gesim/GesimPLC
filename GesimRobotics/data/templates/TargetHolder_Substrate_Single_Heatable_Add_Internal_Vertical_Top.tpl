...
<Root>
  <Header Id="69119eba-dd2a-4dfc-8a03-337d81350f35" ObjType="SubstHolder" ObjName="SingleSubstrateHeater (Internal)" Version="V2.0.17"></Header>
  <Picture File="single_substrate_holder_heater_external_vertical_top.png">
  ...
  <DefaultProperties>
    ...
    <ValveNrCooling Min="1" Max="15" Default="3" Step="1" />
