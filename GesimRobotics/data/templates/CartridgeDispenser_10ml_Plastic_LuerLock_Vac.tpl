...
<Root>
  <Header Id="4eba5f53-74b3-4edc-a110-95f62a42c7dc" ObjType="CartridgeDisp" ObjName="Cartridge Dispenser (10ml)" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <ItvChanPress Min="1" Max="4" Default="1" Step="1" />
    <ItvChanVac Min="1" Max="4" Default="3" Step="1" />
