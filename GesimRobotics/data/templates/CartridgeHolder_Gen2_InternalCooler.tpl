...
<Root>
  ...
  <SeqProcVariables>
    <Item VariableType="Temp1" Name="Temp Core" Min="40" Max="800" Default="370" />
  </SeqProcVariables>
  <ActionLimits>
    <Jog ActionText="Jog">
    ...
    <Heating ActionText="Tempering" SequenceUsage="TRUE" HiddenInManu="FALSE">
      <Temp Min="40" Max="800" Default="370" Step="10" />
    </Heating>
  </ActionLimits>
  <Categories>
