...
<Root>
  <Header Id="25267f0e-fd09-4f3a-a27f-a0f66b198cb8" ObjType="Root" ObjName="BioSynthesizer 5.3/E (SN2350)" Version="V2.0.17"></Header>
  <ActionLimits>
  ...
  <Slots>
    ...
    <Item Nr="5" Name="Head Slot Top" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="MZHead">
          <Categories>
    ...
    <Item Nr="6" Name="Head Slot Bottom" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="MZHead">
          <Categories>
    ...
    <Item Nr="7" Name="Workplate Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
