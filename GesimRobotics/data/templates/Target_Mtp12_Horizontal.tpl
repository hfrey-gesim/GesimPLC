...
<Root>
  <Header Id="58ba6411-64c5-46c9-be74-f851acb738e8" ObjType="Mtp" Version="V2.0.17"></Header>
  ...
  <DefaultProperties>
    ...
    <Cols Min="4" Max="4" Default="4" Step="1" />
    <Rows Min="3" Max="3" Default="3" Step="1" />
    <OffsetCol1 Min="5000" Max="45000" Default="25000" Step="100" />
    <OffsetRow1 Min="10000" Max="32000" Default="17000" Step="100" />
    <SpaceCols Min="8500" Max="50000" Default="26000" Step="100" />
    <SpaceRows Min="8500" Max="40000" Default="26000" Step="100" />
    <WellDiameter Min="5000" Max="50000" Default="23000" Step="100" />
    <WellDepth Min="0" Max="20000" Default="10700" Step="100">
      <!--In GUI als WorkingDepth bezeichnet (kann eingeteached werden)-->
    </WellDepth>
    <WellDepthActual Min="0" Max="20000" Default="10700" Step="100">
