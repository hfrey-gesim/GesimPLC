...
<Root>
  <Header Id="f248a36d-f397-41cb-b4c5-3b6910b3cbc1" ObjType="CartridgeHolder" ObjName="CartridgeHolder (No Board)" Version="V2.0.17" />
  ...
  <Slots>
    ...
    <Item Nr="7" Name="Tool Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Exposure">
          <Categories>
            <Item>cartridgeholder</Item>
