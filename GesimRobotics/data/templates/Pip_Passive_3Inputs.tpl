...
<Root>
  <Header Id="8eadb53e-cd29-4af2-9ee0-478787e7a112" ObjType="PassivePip" ObjName="PassivePipette" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-31500" Max="-31500" Default="-31500" Step="100" />
  ...
  <ActionLimits>
    ...
    <Aspirate SequenceUsage="TRUE" ActionText="Aspirate">
      ...
      <DilInputNr Min="1" Max="3" Default="1" Step="1" />
    </Aspirate>
