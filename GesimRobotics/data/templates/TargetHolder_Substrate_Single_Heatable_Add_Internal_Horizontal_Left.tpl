...
<Root>
  <Header Id="ab62b243-79e1-46eb-9988-d23c7ceddf7e" ObjType="SubstHolder" ObjName="SingleSubstrateHeater (Internal)" Version="V2.0.17"></Header>
  <Picture File="single_substrate_holder_heater_external_horizontal_left.png">
  ...
  <DefaultProperties>
    ...
    <ValveNrCooling Min="1" Max="13" Default="3" Step="1" />
  ...
  <Categories>
    <Item>single+add+internal+horizontal+left</Item>
  </Categories>
</Root>