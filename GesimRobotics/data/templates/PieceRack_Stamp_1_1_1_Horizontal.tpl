...
<Root>
  <Header Id="656a0b64-3154-437c-a887-5ef8d4bf81ea" ObjType="StampMagazine" ObjName="Rack Stamp (3x)" Version="V2.0.17" />
  <Picture File="stamp_rack_3.png">
  ...
  <DefaultProperties>
    ...
    <OffsetStampDetect.Z Min="23000" Max="23000" Default="23000" Step="100" />
  </DefaultProperties>
  <SpecPoints>
    <Item Nr="1" Name="MeasurePoint1" Visible="FALSE">
      ...
      <RelPos.Z Min="6000" Max="16000" Default="15000" />
      <SuitableToolTypes>
