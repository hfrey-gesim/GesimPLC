...
<Root>
  <Header Id="9e36b089-73c1-46a9-a1e9-cdf764b89acb" ObjType="MZHead" ObjName="Head" Version="V2.0.17"></Header>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="110000" Max="110000" Default="110000" Step="100" />
  ...
  <Slots>
    ...
    <Item Nr="3" Name="Axis 3" RelPos.X="-44500" RelPos.Y="36000" RelPos.Z="108000" Diameter="18000" Disabled="FALSE">
      <ChildLimit>
        ...
        <Item ObjType="TwinPiezoHolder" />
        <Item ObjType="VermesDisp" />
        <Item ObjType="Extruder" />
        <Item ObjType="PowderPip" />
