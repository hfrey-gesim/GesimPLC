...
<Root>
  <Header Id="17441f3d-c899-4d7e-bd1d-d5501c87b022" ObjType="CartridgeHolder" ObjName="CartridgeHolder (Internal Heater Disabled)" Version="V2.0.17" />
  <Picture File="cartridge_holder_no_heater_gap_gen1.png" InFrontOfPieces="TRUE">
    <Dimension X="34000" Y="84800" />
    <Offset X="-17000" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-21300" Max="-21300" Default="-21300" Step="500" />
  ...
  <Slots>
    ...
    <Item Nr="2" Name="Tool Slot" RelPos.X="0" RelPos.Y="0" RelPos.Z="0" Disabled="FALSE">
      <ChildLimit>
