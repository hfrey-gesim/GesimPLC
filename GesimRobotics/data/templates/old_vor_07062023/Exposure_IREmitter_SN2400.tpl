...
<Root>
  <Header Id="6f753725-da43-43a6-8ff2-6989f9daf6a9" ObjType="Exposure" ObjName="IR Emitter" Version="V2.0.17" />
  <Picture File="ir_emitter_sn2400.png">
    <Dimension X="26000" Y="54038" />
    <Offset X="-13000" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-41038" Max="-41038" Default="-41038" Step="100" />
  ...
  <ActionLimits>
    ...
    <Expose SequenceUsage="TRUE" ActionText="Expose">
      ...
      <Time Min="1" Max="100000" Default="1" AllowZero="FALSE" Step="10"></Time>
    </Expose>
