...
<Root>
  <Header Id="37bea517-96db-4275-9507-8ae1066d7794" ObjType="Extruder" ObjName="FilamentExtruder" Version="V2.0.17" />
  <Picture File="fdm_extruder_gen2_right.png">
    <Dimension X="35000" Y="181500" />
    <Offset X="-15500" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    <RelPos.X Min="-26000" Max="-26000" Default="-26000" Step="500"></RelPos.X>
    <RelPos.Y Min="1500" Max="1500" Default="1500" Step="500" />
    <RelPos.Z Min="-97500" Max="-97500&#xD;&#xA;" Default="-97500" Step="500" />
    <SubType>ScrewExtruder1</SubType>
    <FactorFeed Min="1" Max="300000000" Default="13200" />
    <FactorDistance Min="1" Max="10000000" Default="5500" />
    <Feed Min="100" Max="500000" Default="1000" Step="1" />
  ...
  <ActionLimits>
    ...
    <Extrude ActionText="Extrude" SequenceUsage="TRUE">
      <Distance Min="-200000" Max="200000" Default="0" AllowZero="TRUE" Step="100" />
    </Extrude>
