...
<Root>
  <Header Id="80fcac70-c60f-42ee-bd18-b162bfc2e7bd" ObjType="Exposure" ObjName="UV-Pen" Version="V2.0.17" />
  ...
  <DefaultProperties>
    <!--für MultiToolHolder SN2351 X/Y/Z= XX/YY/0-->
    <RelPos.X Min="-55500" Max="0" Default="-55500" Step="100" />
    <RelPos.Y Min="0" Max="0" Default="0" Step="100" />
    <RelPos.Z Min="-110000" Max="0" Default="-68000" Step="100">
      <!--physische Position bei -68mm ist: Markierungsbegin 2,4cm über Oberkante des Halters -->
      <!--physische Position bei 0 ist: Markierungsbegin 7cm über Oberkante des Halters -->
    </RelPos.Z>
    ...
    <WorkingDistance Min="1000" Max="80000" Default="50000" Step="100" />
    <!--MultiZOutput-->
  </DefaultProperties>
  <ActionLimits>
    <Jog ActionText="Jog">
