...
<Root>
  <Header Id="5a90ca0f-3166-4184-a159-fa3d9e6d9441" ObjType="TargetTray" ObjName="TargetTray" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <Depth Min="0" Max="250000" Default="250000" Step="100" />
    <Height Min="12000" Max="12000" Default="12000" Step="100" />
    <FreeHeight Min="1" Max="100000" Default="38000" Step="100" AllowZero="TRUE" />
  </DefaultProperties>
  <Slots>
    ...
    <Item Nr="4" Name="MtpHolder Slot 1" RelPos.X="24000" RelPos.Y="600" RelPos.Z="0" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
    ...
    <Item Nr="5" Name="MtpHolder Slot 2" RelPos.X="121000" RelPos.Y="600" RelPos.Z="0" Depth="0" Diameter="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="MtpHolder">
          <Categories>
            <Item>double+coolable+horizontal+right</Item>
