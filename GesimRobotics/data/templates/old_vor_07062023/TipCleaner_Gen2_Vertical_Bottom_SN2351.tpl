...
<Root>
  <Header Id="&#xD;&#xA;6ddcacd2-ac24-49c3-a372-aa01014fafcb" ObjType="TipCleanerGen2" ObjName="TipCleaner" Version="V2.0.17"></Header>
  ...
  <DefaultProperties>
    ...
    <WireCleaningStart.X Min="20000" Max="26000" Default="23000" Step="100" />
    <WireCleaningStart.Y Min="35000" Max="45000" Default="40600" Step="100" />
    <WireCleaningStart.Z Min="-2000" Max="0" Default="-700" Step="100" />
    <WireCleaningEnd.X Min="20000" Max="26000" Default="23000" Step="100" />
  ...
  <Slots>
    ...
    <Item Nr="5" Name="CleaningBrush Slot 5" RelPos.X="2700" RelPos.Y="75750" RelPos.Z="-24100" Dim.X="15000" Dim.Y="19000">
      <ChildLimit>
        <Item ObjType="CleaningBrush">
          <Categories>
