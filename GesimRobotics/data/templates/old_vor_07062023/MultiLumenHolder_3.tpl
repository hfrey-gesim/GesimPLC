...
<Root>
  ...
  <Slots>
    <Item Nr="1" Name="Lumen 1" RelPos.X="425" RelPos.Y="736" RelPos.Z="0" Disabled="FALSE">
      <ChildLimit>
    ...
    <Item Nr="2" Name="Lumen 2" RelPos.X="425" RelPos.Y="-736" RelPos.Z="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="PassivePip">
          <Categories>
            <Item>dispense+multilumen</Item>
    ...
    <Item Nr="3" Name="Lumen 3" RelPos.X="-850" RelPos.Y="0" RelPos.Z="0" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="PassivePip">
          <Categories>
            <Item>dispense+multilumen</Item>
