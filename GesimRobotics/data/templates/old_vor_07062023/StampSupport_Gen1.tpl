...
<Root>
  <Header Id="c2f52012-0a68-4b46-839e-33140f7d182b" ObjType="StampSupport" Version="V2.0.17" />
  ...
  <DefaultProperties>
    <RelPos.X Min="-3000" Max="-3000" Default="-3000" Step="100" />
    <RelPos.Y Min="54000" Max="54000" Default="54000" Step="100" />
      <!--laut CAD 54000-->
  ...
  <ActionLimits>
    ...
    <SetPressure SequenceUsage="TRUE" ActionText="Set Pressure">
      <Pressure Min="1" Max="100" Default="50" Step="5" />
    ...
    <TeachTool ActionText="TeachTool" SequenceUsage="FALSE">
      <TargetTypes>
        <Item>StampMagazine</Item>
      </TargetTypes>
