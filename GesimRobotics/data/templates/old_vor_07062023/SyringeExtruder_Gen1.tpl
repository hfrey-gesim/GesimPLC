...
<Root>
  <Header Id="66c08d41-3375-47de-9892-14f782150bfb" ObjType="Extruder" ObjName="SyringeExtruder" Version="V2.0.17" />
  <Picture File="syringe_extruder.png" InFrontOfPieces="TRUE">
  ...
  <ActionLimits>
    ...
    <CleanTip ActionText="Clean Tip" SequenceUsage="TRUE">
      ...
      <DispenseTime Min="0" Max="5000" Default="0" Step="100" />
