...
<Root>
  <Header Id="63f4eb88-4ddf-4e37-b27b-9d7bd77f8440" ObjType="MultiCartridgeHolder" ObjName="CoreShellHolder" Version="V2.0.17"></Header>
  <Picture File="coreshell_holder_no_heater_gen1.png" InFrontOfPieces="TRUE">
    <Dimension X="34000" Y="148200" />
    <Offset X="-17000" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-114200" Max="-114200" Default="-114200" Step="500" />
    <HeaterExist Default="FALSE" />
    <ShowTemp Default="FALSE" />
  </DefaultProperties>
  <Slots>
    <Item Nr="1" Name="Disp Slot Core" RelPos.X="0" RelPos.Y="0" RelPos.Z="108700" Disabled="FALSE">
      <ChildLimit>
    ...
    <Item Nr="2" Name="Disp Slot Shell" RelPos.X="0" RelPos.Y="0" RelPos.Z="68700" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="CartridgeDisp">
          <Categories>
            <Item>shell</Item>
  ...
  <ActionLimits>
    ...
    <Heating SequenceUsage="FALSE" HiddenInManu="TRUE" ActionText="Heating">
