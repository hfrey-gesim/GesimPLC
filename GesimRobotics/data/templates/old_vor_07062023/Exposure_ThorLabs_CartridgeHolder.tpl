...
<Root>
  <Header Id="8fa3d560-c290-4eca-9031-24dcbb21f06b" ObjType="Exposure" ObjName="ThorLabs" Version="V2.0.17" />
  <Picture File="exposure_cartridgeholder.png">
    <Dimension X="30000" Y="70000" />
    <Offset X="-6400" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    <RelPos.X Min="-37000" Max="-37000" Default="-37000" Step="100" />
    <RelPos.Y Min="8600" Max="8600" Default="8600" Step="100" />
    <RelPos.Z Min="-70000" Max="-70000" Default="-70000" Step="100" />
    <TriggerBehavior Min="0" Max="1" Default="1" Step="1" />
    <TriggerChannel Min="1" Max="3" Default="1" Step="1" />
    <WorkingDistance Min="50000" Max="80000" Default="50000" Step="100" />
  </DefaultProperties>
  <ActionLimits>
    <Jog ActionText="Jog">
    ...
    <Expose SequenceUsage="TRUE" ActionText="Expose">
      <Brightness Min="0" Max="1000" Default="500" Step="50" />
