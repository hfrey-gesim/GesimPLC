...
<Root>
  <Header Id="93f48a39-7d92-4bee-b77e-0ab0c3ab7294" ObjType="CustomUnitType1" ObjName="FlowCell (SN2377)" Version="V2.0.17" />
  <Picture File="custom_unit_type_1_vertical.png">
    <Dimension X="86000" Y="128000" />
    <Offset X="0" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <Depth Min="128000" Max="128000" Default="128000" Step="100" />
  ...
  <Slots>
    <Item Nr="1" Name="Slot FlowCell 1" RelPos.X="15250" RelPos.Y="40000" RelPos.Z="-14000" Dim.X="19000" Dim.Y="60000" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Slide">
          <Categories>
    ...
    <Item Nr="2" Name="Slot FlowCell 2" RelPos.X="51250" RelPos.Y="40000" RelPos.Z="-14000" Dim.X="19000" Dim.Y="60000" Disabled="FALSE">
      <ChildLimit>
        <Item ObjType="Slide">
          <Categories>
            <Item>customunit+type1</Item>
