...
<Root>
  <Header Id="fac48ebb-abd8-4fb4-aab5-99df55fe643c" ObjType="CartridgeHolder" ObjName="CartridgeHolder (No Board)" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-46700" Max="-6700" Default="-26700" Step="500" />
