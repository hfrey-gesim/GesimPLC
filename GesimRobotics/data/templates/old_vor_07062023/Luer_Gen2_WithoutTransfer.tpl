...
<Root>
  <Header Id="9bb8166b-485c-4e15-8fc2-33820ad22fbd" ObjType="Luer" ObjName="Luer" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <ValveNrDiluter Min="0" Max="0" Default="0" Step="1" />
  ...
  <ActionLimits>
    <Jog ActionText="Jog">
      ...
      <FastSpeedZ Min="10" Max="60000" Default="60000" Step="5000" />
      <ManuSpeedZ Min="10" Max="60000" Default="60000" Step="1000" />
    ...
    <MoveToTarget SequenceUsage="TRUE" ActionText="Move to Target">
      ...
      <SpeedZ Min="0" Max="60000" Default="60000" Step="100" AllowZero="TRUE" />
    ...
    <Aspirate SequenceUsage="TRUE" ActionText="Aspirate">
      ...
      <Flow Min="50" Max="20000" Default="2000" Step="100" />
    </Aspirate>
    ...
    <GetPipSample SequenceUsage="FALSE" ActionText="Get Sample" HiddenInManu="TRUE">
      ...
      <Flow Min="2" Max="20000" Default="2000" Step="10" />
    ...
    <ActionOnArray SequenceUsage="TRUE" ActionText="Action on Array">
      ...
      <SpeedZ Min="10" Max="60000" Default="60000" Step="100" />
      <SpeedZRelease Min="10" Max="60000" Default="60000" Step="100" />
      ...
      <ReleaseMoveDelay Min="0" Max="30000" Default="0" Step="100" />
      <ActionTypes>
