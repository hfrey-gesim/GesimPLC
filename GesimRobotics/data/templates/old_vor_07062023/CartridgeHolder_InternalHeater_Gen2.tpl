...
<Root>
  <Header Id="2b448fc1-25dd-4c3a-bf1c-17dfe281ce67" ObjType="CartridgeHolder" ObjName="CartridgeHolder (Internal Heater)" Version="V2.0.17" />
  <Picture File="cartridge_holder_with_heater_gen2.png" InFrontOfPieces="TRUE">
    <Dimension X="35000" Y="206500" />
    <Offset X="-17500" Y="0" />
  </Picture>
  ...
  <Slots>
    ...
    <Item Nr="3" Name="Tool Slot 2" RelPos.X="0" RelPos.Y="0" RelPos.Z="80500" Disabled="FALSE">
      <ChildLimit>
  ...
  <ActionLimits>
    ...
    <Heating ActionText="Heating" SequenceUsage="TRUE" HiddenInManu="FALSE">
      ...
      <Temp2 Min="200" Max="2700" Default="200" Step="10" />
    </Heating>
  </ActionLimits>
  <Categories>
    <Item>standard</Item>
