...
<Root>
  <Header Id="d42598d1-9fca-4de5-9991-738e169a171b" ObjType="Extruder" ObjName="PureDyneExtruder_1" Version="V2.0.17" />
  ...
  <ActionLimits>
    ...
    <MoveZ HiddenInManu="TRUE" SequenceUsage="TRUE" ActionText="Move Z">
      ...
      <Distance Min="-10000" Max="10000" Default="1" Step="10" />
