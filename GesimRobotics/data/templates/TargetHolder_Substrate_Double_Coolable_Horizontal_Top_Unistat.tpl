...
<Root>
  <Header Id="f9050214-0ec9-479d-b164-012beef28b24" ObjType="SubstHolderUnistat" ObjName="DoubleSubstrateCooler Unistat" Version="V2.0.17" />
  ...
  <DefaultProperties>
    ...
    <Height Min="25000" Max="27000" Default="26500" Step="100" />
  ...
  <ActionLimits>
    <Cooling SequenceUsage="TRUE" ActionText="Temperature control">
      <Temp Min="-200" Max="+1000" Default="210" Step="10" />
    </Cooling>
