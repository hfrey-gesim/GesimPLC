...
<Root>
  <Header Id="4d3b6553-874e-4706-8365-a6402fcf5e84" ObjType="CartridgeDisp" ObjName="Cartridge Dispenser (10ml)" Version="V2.0.17" />
  <Picture File="cartridge_dispenser_10ml_plastic.png" InFrontOfPieces="TRUE">
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-91000" Max="-91000" Default="-91000" Step="500" />
    <ItvChanPress Min="1" Max="5" Default="1" Step="1" />
    <ItvChanVac Min="1" Max="15" Default="3" Step="1" />
    <DigiOutMzValvePress Min="1" Max="15" Default="6" Step="1" />
