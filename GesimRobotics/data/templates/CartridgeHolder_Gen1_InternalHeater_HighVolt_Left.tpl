...
<Root>
  <Header Id="87336c11-906e-4d25-ac60-4d1b9f14899f" ObjType="CartridgeHolder" ObjName="CartridgeHolder (HV/Internal Heater)" Version="V2.0.17" />
  <Picture File="cartridge_holder_with_heater_gen1_high_volt.png" InFrontOfPieces="TRUE">
    <Dimension X="49000" Y="152800" />
    <Offset X="-32000" Y="0" />
  </Picture>
