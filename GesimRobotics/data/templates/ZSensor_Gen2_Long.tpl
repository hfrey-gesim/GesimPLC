...
<Root>
  <Header Id="fdd6d8be-a0ea-4fc0-a746-c7974cd8aed6" ObjType="ZSensor" ObjName="ZSensor" Version="V2.0.17" />
  <Picture File="z_sensor_gen2_long.png">
    <Dimension X="12000" Y="87000" />
    <Offset X="-7450" Y="0" />
  </Picture>
  ...
  <DefaultProperties>
    ...
    <RelPos.Z Min="-87000" Max="-87000" Default="-87000" Step="500" />
  </DefaultProperties>
  <ActionLimits>
    <Jog ActionText="Jog">
